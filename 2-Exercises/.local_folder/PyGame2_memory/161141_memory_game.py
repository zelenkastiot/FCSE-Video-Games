...
def drawBoxCovers(board, boxes, coverage):
    ...
    for box in boxes:
        ...
        if coverage > 0:  # only draw the cover if there is an coverage
            pygame.draw.rect(DISPLAYSURF, BOX_COLOR, (left, top, coverage, coverage)) ####################### BARANJE 7
    pygame.display.update()
    FPSCLOCK.tick(FPS)
...
def startGameAnimation(board):
    ...
    boxGroups = splitIntoGroupsOf(len(boxes), boxes) ######################################################## BARANJE 5
...
def gameWonAnimation(board):
    ...
    color = (150, 0, 0)
    x_start, y_start = leftTopCoordsOfBox(0, 0)

    x_current = x_start
    y_current = y_start
    pygame.draw.rect(DISPLAYSURF, color, (x_current, y_current, BOX_SIZE, BOX_SIZE))
    pygame.display.update()
    pygame.time.wait(150)

    x_current = x_start + GAP_SIZE + BOX_SIZE
    y_current = y_start
    pygame.draw.rect(DISPLAYSURF, color, (x_current, y_current, BOX_SIZE, BOX_SIZE))
    pygame.display.update()
    pygame.time.wait(150)

    x_current = x_start + GAP_SIZE + BOX_SIZE + GAP_SIZE + BOX_SIZE
    y_current = y_start
    pygame.draw.rect(DISPLAYSURF, color, (x_current, y_current, BOX_SIZE, BOX_SIZE))
    pygame.display.update()
    pygame.time.wait(150)

    x_current = x_start + GAP_SIZE + BOX_SIZE + GAP_SIZE + BOX_SIZE + GAP_SIZE + BOX_SIZE
    y_current = y_start
    pygame.draw.rect(DISPLAYSURF, color, (x_current, y_current, BOX_SIZE, BOX_SIZE))
    pygame.display.update()
    pygame.time.wait(150)
    ...
    x_current = x_start
    y_current = y_start + GAP_SIZE + BOX_SIZE
    pygame.draw.rect(DISPLAYSURF, color, (x_current, y_current, BOX_SIZE, BOX_SIZE))
    pygame.display.update()
    pygame.time.wait(150)
    ...
    x_current = x_start
    y_current = y_start + GAP_SIZE + BOX_SIZE + GAP_SIZE + BOX_SIZE
    pygame.draw.rect(DISPLAYSURF, color, (x_current, y_current, BOX_SIZE, BOX_SIZE))
    pygame.display.update()
    pygame.time.wait(150)
    ...
    x_current = x_start
    y_current = y_start + GAP_SIZE + BOX_SIZE + GAP_SIZE + BOX_SIZE + GAP_SIZE + BOX_SIZE
    pygame.draw.rect(DISPLAYSURF, color, (x_current, y_current, BOX_SIZE, BOX_SIZE))
    pygame.display.update()
    pygame.time.wait(150)
    ...
    x_current = x_start
    y_current = y_start + GAP_SIZE + BOX_SIZE + GAP_SIZE + BOX_SIZE + GAP_SIZE + BOX_SIZE + GAP_SIZE + BOX_SIZE
    pygame.draw.rect(DISPLAYSURF, color, (x_current, y_current, BOX_SIZE, BOX_SIZE))
    pygame.display.update()
    pygame.time.wait(150)
    ...
    font_won = pygame.font.Font('freesansbold.ttf', 40)
    font = pygame.font.Font('freesansbold.ttf', 25)

    # create a text surface object,
    # on which text is drawn on it.
    text1 = font_won.render("You Won the game!", True, WHITE)
    text2 = font.render("Match all pairs to win.", True, WHITE)

    DISPLAYSURF.fill((0, 0, 0))
    DISPLAYSURF.blit(text1, (10, 0))
    DISPLAYSURF.blit(text2, (10, 45))
    pygame.time.wait(70)

    # Attempt fo Click event/ fail
    # while True:
    #     clock.tick(10)
