...
CAMERASLACK_Y = 80     # how far from the center the squirrel moves before moving the camera (along y axis)
########################################################################################################################
MOVERATE = 9         # how fast the player moves
BOUNCERATE = 6       # how fast the player bounces (large is slower)
BOUNCEHEIGHT = 30    # how high the player bounces
STARTSIZE = 25       # how big the player starts off
WINSIZE = 20        # how big the player needs to be to win
    ...
    while True: # main game loop
        ...
        for sObj in squirrelObjs:
            ...
            if random.randint(0, 99) < DIRCHANGEFREQ:
                ...
                sObj['movey'] = abs(getRandomVelocity())  ##################################################### Барање 3
            ...
            for i in range(len(squirrelObjs)-1, -1, -1):
                ...
                if 'rect' in sqObj and playerObj['rect'].colliderect(sqObj['rect']):
                    ...
                    if sqObj['width'] * sqObj['height'] <= playerObj['size']**2:
                        ...
                        playerObj['size'] -= int( (sqObj['width'] * sqObj['height'])**0.3 ) - 1 ############## Барање 4
                        del squirrelObjs[i]
...
def makeNewSquirrel(camerax, cameray):
    ...
    sq['movey'] = abs(getRandomVelocity())  ################################################################### Барање 3
