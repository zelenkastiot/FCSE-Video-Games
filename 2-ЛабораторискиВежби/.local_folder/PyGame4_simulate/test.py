...
WHITE        = (255, 255, 255)
BLACK        = (  0,   0,   0)
BRIGHTRED    = (200,   0,   0)  # 1ва боја
RED          = (100,   0,   0)  # 1ва посветла боја
BRIGHTGREEN  = (  0, 200,   0)  # 2ра боја
GREEN        = (  0, 100,   0)  # 2ра посветла боја
BRIGHTBLUE   = (  0,   0, 200)  # 3та боја
BLUE         = (  0,   0, 100)  # 3та посветла боја
BRIGHTYELLOW = (200, 200,   0)  # 4та боја
YELLOW       = (100, 100,   0)  # 4 посветла боја
BRIGHTPURPLE   = (210, 105, 30)
PURPLE         = (150, 100, 29)
BRIGHTORANGE    = (231, 84, 128)
ORANGE          = (100, 80, 80)
DARKGRAY     = ( 40,  40,  40)
bgColor = BLACK
...
def main():
    global FPSCLOCK, DISPLAYSURF, BASICFONT, BEEP1, BEEP2, BEEP3, BEEP4, BEEP5, BEEP6, TIMEOUT
    ...
    while True: # main game loop
        ...
        if not waitingForInput:
            ...
            pattern.insert(0, random.choice((YELLOW, BLUE, RED, GREEN, ORANGE, PURPLE))) #replacing append(end of the list) with insert at index 0(start of the list)
...
def drawButtons():
    ...
    pygame.draw.rect(DISPLAYSURF, ORANGE, PINKRECT)
    pygame.draw.rect(DISPLAYSURF, PURPLE, BROWNRECT)
