...
############################################################################################################### БАРАЊЕ 3
        ...
        text_com = f'Combined moves: {len(allMoves) + len(solutionSeq)}'   # текст за чекори од компјутер
...
def drawBoard(board, message):
    ...
    DISPLAYSURF.blit(HELP_SURF, HELP_RECT)  # Цртај HELP копче
...
def help_timer(myBoard, msg):
    ...
    text = "Move one of the red squares. Help time: " + str(counter).rjust(3) if counter > 0 else 'Time up!'
